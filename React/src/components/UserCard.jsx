  ...
  return (
    ...
    <div class="p-4 xl:ml-80">
      ...
      <div class="mt-12">
        ...
        <div class="mb-12 grid grid-cols-5 gap-20 xl:grid-cols-1">
                    ...
                    <td class="py-3 px-5 border-b border-blue-gray-50">
                      <div class="w-10/12">
                        ...
                        <div class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                          <div class="flex justify-center items-center h-full bg-gradient-to-tr from-blue-600 to-blue-400 text-white" style={{}}></div>
                        </div>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="py-3 px-5 border-b border-blue-gray-50">
                      <div class="w-10/12">
                        ...
                        <div class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                          <div class="flex justify-center items-center h-full bg-gradient-to-tr from-green-600 to-green-400 text-white" style={{}}></div>
                        </div>
                      </div>
                    </td>
                  </tr>
